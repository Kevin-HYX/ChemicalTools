...
import org.kevin.tools.Inner;
import org.kevin.tools.SquareSolver;
                ...
                case 1:
                    ...
                    switch (inner.oneInt()) {
                        case 1:
                            ...
                            System.out.println("溶剂质量 = " + new SquareSolver().solveMainOneOne(arr1[1] / 100, arr1[1] / 100 * arr1[0] - arr1[0]));
                            break;
                        case 2:
                            System.out.println("输入溶液和质量分数");
                            double[] arr2 = inner.Double(2);
                            System.out.println("溶质质量 = " + new SquareSolver().solveMainOneOne(arr2[1] / 100 - 1, arr2[1] * arr2[0] / 100));
                            break;
                        case 3:
                        ...
                        case 4:
                            ...
                            System.out.println("该类溶质溶剂在该温度下的溶解度 = " + new SquareSolver().solveMainOneOne(arr4[0], -100 * arr4[1]));
                            break;
                        default: {
